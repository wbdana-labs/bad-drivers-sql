...
class Collision
  ...
  attr_accessor :state, :collisionsbillionmiles, :percentagespeeding, :percentagealcohol, :percentagenotdistracted, :percentagenoprior, :id
  ...
  def self.create_table
    ...
    (
      ...
      state TEXT,
      collisionsbillionmiles INTEGER,
      percentagespeeding INTEGER,
      percentagealcohol INTEGER,
      percentagenotdistracted INTEGER,
      percentagenoprior INTEGER
    );
    SQL
    DB[:conn].execute(sql)
  end
  ...
  def self.create(state, collisionsbillionmiles, percentagespeeding, percentagealcohol, percentagenotdistracted, percentagenoprior)
    collision_data = Collision.new(state, collisionsbillionmiles, percentagespeeding, percentagealcohol, percentagenotdistracted, percentagenoprior)
    collision_data.save
  end
